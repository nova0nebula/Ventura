...
while (listVault.length != 0) {
  ...
  }for(let i=0;i<R;i++){robbers[i]-=smaller;}times+=smaller;}let bigger=0;for(let i=0;i<robbers.length;i++){if(robbers[i]>bigger){bigger=robbers[i];}}console.log(times+bigger);